...
## Switches
set_property PACKAGE_PIN V17 [get_ports {dina[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {dina[0]}]
set_property PACKAGE_PIN V16 [get_ports {dina[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {dina[1]}]
set_property PACKAGE_PIN W16 [get_ports {dina[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {dina[2]}]
set_property PACKAGE_PIN W17 [get_ports {dina[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {dina[3]}]
set_property PACKAGE_PIN W15 [get_ports {addra[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {addra[0]}]
set_property PACKAGE_PIN V15 [get_ports {addra[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {addra[1]}]
set_property PACKAGE_PIN W14 [get_ports {addra[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {addra[2]}]
set_property PACKAGE_PIN W13 [get_ports {addra[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {addra[3]}]
set_property PACKAGE_PIN V2 [get_ports {wea[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {wea[0]}]
set_property PACKAGE_PIN T3 [get_ports {ena}]
...
set_property PACKAGE_PIN U2 [get_ports {annode[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {annode[1]}]
set_property PACKAGE_PIN U4 [get_ports {annode[0]}]
